...
const AdminControls = () => {
    ...
    const handlePdfFileUpload = async () => {
        ...
        formData.append('category', "current-affairs");
    ...
    return (
        <div>
            {/* Current Affairs Upload Section begins */}
            <div className="my-10 flex flex-col gap-5 items-start mx-10">
                <h1 className="text-2xl font-bold">Upload Current Affairs</h1>
            ...
            {/* Current Affairs Upload Section Ends */}
            {/* ==================================================================================== */}
            {/* Question Paper Section Begins */}
