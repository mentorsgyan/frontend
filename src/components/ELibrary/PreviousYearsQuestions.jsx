...
const PreviousYearsQuestions = () => {
  // This is just Tailwindcss just to make the code looks cleaner
    const styles = {
        ...
        mainHeaderText: "border border-black text-center font-bold text-base font-bold md:text-4xl whitespace-normal break-words",
    }
  ...
  return (
      <div className="flex sm:justify-center overflow-x-auto h-[90vh] w-full items-start">
          <div className={`grid grid-cols-10 w-full min-w-[800px] border-4 mt-4 border-black bg-white dark:bg-gray-800 md:w-4/5`}>
            <>
            <h1 className={`${styles.mainHeaderText} col-span-3 p-4 border-r-4`}>Prelims</h1>
          ...
          <h1 className={`${styles.titlesStyle} border-r-4`}>GS</h1>
      ...
      <React.Fragment key={index}>
        ...
        <a className={`${styles.linksStyle} border-r-4`} href={question.gs || ""}>Read more</a>
